  ...
  var body: some View {
    ZStack {
      VStack {
        ...
        PhotosList(photos: $album.pictures, isShared: isShared, albumId: album.id ?? "")
      }
    }
    .onAppear {
      Task {
...
#Preview {
  AlbumPhotosView(album: Album(owner_id: "12345", pictures: [], title: "Test album"), isShared: false)
}
