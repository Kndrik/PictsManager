...
class ImageDetailsViewModel: ObservableObject {
  ...
  func getSharedPictureById(albumId: String, pictureId: String) async {
    guard let url = URL(string: Api.Album.albumList + albumId + "/" + pictureId) else {
      Logger.imageDetails.error("Invalid URL for shared picture endpoint")
      return
    }
    ...
    do {
      ...
      guard let httpResponse = response as? HTTPURLResponse,
        ...
        Logger.imageDetails.error("Failed to fetch shared picture data")
        return
      }
